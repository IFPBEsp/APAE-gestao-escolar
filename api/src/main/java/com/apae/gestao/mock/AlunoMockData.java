...
public class AlunoMockData implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (alunoRepository.count() == 0) {
            // Utilizando o construtor simplificado:
            // (id, nome, deficiencia, dataNascimento, telefoneResponsavel, nomeResponsavel)
            List<Aluno> alunos = List.of(
                // Aluno 1
                new Aluno(
                    null, "Ana Beatriz Costa", "Transtorno do Espectro Autista (TEA) leve", 
                    LocalDate.of(2014, 5, 10), "(11) 98765-1111", "Mãe da Ana"
                ),
                // Aluno 2
                new Aluno(
                    null, "Carlos Eduardo Silva", "Síndrome de Down", 
                    LocalDate.of(2013, 8, 25), "(11) 99876-2222", "Pai do Carlos"
                ),
                // Aluno 3
                new Aluno(
                    null, "João Pedro Oliveira", "Deficiência Visual Total", 
                    LocalDate.of(2015, 3, 1), "(21) 97654-3333", "Mãe do João"
                ),
                // Aluno 4
                new Aluno(
                    null, "Mariana Silva Santos", "Transtorno do Espectro Autista (TEA) leve", 
                    LocalDate.of(2016, 11, 19), "(21) 96543-4444", "Pai da Mariana"
                ),
                // Aluno 5
                new Aluno(
                    null, "Pedro Lucas Mendes", "Deficiência Auditiva Bilateral", 
                    LocalDate.of(2017, 7, 30), "(31) 95432-5555", "Mãe do Pedro"
                ),
                // Aluno 6
                new Aluno(
                    null, "Eduardo Gomes Ferreira", "TDAH e Dislexia", 
                    LocalDate.of(2012, 1, 14), "(31) 94321-6666", "Pai do Eduardo"
                ),
                // Aluno 7
                new Aluno(
                    null, "Pedro Silva Neto", "Síndrome de Down", 
                    LocalDate.of(2014, 4, 5), "(41) 93210-7777", "Mãe do Pedro S."
                ),
                // Aluno 8
                new Aluno(
                    null, "Thiago da Silva Martins", "Deficiência Visual Parcial", 
                    LocalDate.of(2015, 9, 22), "(41) 92109-8888", "Avô do Thiago"
                ),
                // Aluno 9
                new Aluno(
                    null, "Marina Costa Ribeiro", "Transtorno do Espectro Autista (TEA) nível 1", 
                    LocalDate.of(2013, 2, 7), "(51) 91098-9999", "Mãe da Marina"
                ),
                // Aluno 10
                new Aluno(
                    null, "Pedro Neto Almeida", "Deficiência Auditiva Parcial", 
                    LocalDate.of(2016, 12, 3), "(51) 90987-0000", "Pai do Pedro N."
                ),
                // Aluno 11
                new Aluno(
                    null, "Ana Luiza Nogueira", "Deficiência Intelectual Leve", 
                    LocalDate.of(2014, 6, 18), "(61) 99876-1234", "Mãe da Ana L."
                ),
                // Aluno 12
                new Aluno(
                    null, "João Gabriel Melo", "Síndrome de Down", 
                    LocalDate.of(2017, 10, 28), "(61) 98765-2345", "Pai do João G."
                ),
                // Aluno 13
                new Aluno(
                    null, "João Lucas Pires", "Deficiência Visual Total", 
                    LocalDate.of(2012, 3, 9), "(71) 97654-3456", "Mãe do João L."
                ),
                // Aluno 14
                new Aluno(
                    null, "Margarida Oliveira Vaz", "Transtorno do Espectro Autista (TEA) nível 2", 
                    LocalDate.of(2018, 1, 6), "(71) 96543-4567", "Pai da Margarida"
                ),
                // Aluno 15
                new Aluno(
                    null, "Larissa Pereira Rocha", "Deficiência Auditiva Bilateral", 
                    LocalDate.of(2015, 11, 12), "(81) 95432-5678", "Mãe da Larissa"
                ),
                // Aluno 16
                new Aluno(
                    null, "Beatriz Costa Freire", "Paralisia Cerebral", 
                    LocalDate.of(2013, 5, 29), "(81) 94321-6789", "Pai da Beatriz"
                ),
                // Aluno 17
                new Aluno(
                    null, "Carlos Emanuel Lima", "Síndrome de Down", 
                    LocalDate.of(2016, 9, 2), "(91) 93210-7890", "Mãe do Carlos E."
                ),
                // Aluno 18
                new Aluno(
                    null, "Peter Jordan Nolasco", "Deficiência Visual Parcial", 
                    LocalDate.of(2014, 8, 20), "(91) 92109-8901", "Pai do Peter"
                ),
                // Aluno 19
                new Aluno(
                    null, "Eduarda Silva Almeida", "Deficiência Intelectual Moderada", 
                    LocalDate.of(2017, 1, 1), "(11) 91098-9012", "Mãe da Eduarda"
                ),
                // Aluno 20
                new Aluno(
                    null, "Pedro Almeida Cruz", "Deficiência Auditiva Parcial", 
                    LocalDate.of(2012, 10, 17), "(11) 90987-0123", "Pai do Pedro A."
                )
            );

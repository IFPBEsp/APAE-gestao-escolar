-- Versão inicial das funções usadas pela API
-- Funções: get_chamada_por_turma_e_data, listar_professores_com_turmas, listar_turmas_otimizado

-- 1) Função get_chamada_por_turma_e_data
...
-- 2) Função listar_professores_com_turmas
...
-- 3) Função listar_turmas_otimizado

  ...
  return (
    <main className="p-4 md:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
          {cards.map((card, i) => {
            ...
            return (
              <div
                key={i}
                className="bg-white p-4 md:p-6 rounded-xl border-2 border-[#B2D7EC] shadow-sm"
              >
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl border-2 border-[#B2D7EC] shadow-sm">
